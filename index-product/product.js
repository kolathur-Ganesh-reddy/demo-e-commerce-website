...
const clothings = {
    ...
    18: {
        ...
        price: "$150.00",
        description: "Top-notch quality at an affordable price.",
        image: "../shirts/hoodie2.avif",
        thumbnails: [
            "../shirts/hoodie2.avif",
            "../shirts/whoodie2.avif",
            "../shirts/whoodie3.avif",
            "../shirts/whoodie4.avif"
        ],
        related: [17, 19, 20],
    },
    19: {
    ...
    20: {
        ...
        price: "$150.00",
        description: "Top-notch quality at an affordable price.",
        image: "../shirts/hoodie4.avif",
        thumbnails: [
            "../shirts/hoodie4.avif",
            "../shirts/whitehoodie2.avif",
            "../shirts/whitehoodie3.avif",
            "../shirts/whitehoodie4.avif"
        ],
        related: [17, 18, 19],
    },
...
if (clothings[clothingId]) {
   ...
   // related product 
    ...
    if (clothings[relatedId]) {
        ...
        clothingLink.href = `product.html?id=${relatedId}`;
